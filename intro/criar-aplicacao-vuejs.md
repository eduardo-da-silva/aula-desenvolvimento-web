...
<span style="display: flex; justify-content: space-between;"><span>[&lt; Introdução](intro "Voltar")</span> <span>[Os componentes de arquivo único &gt;](intro/single-file-components.html "Próximo")</span></span>