...
<span style="display: flex; justify-content: space-between;"><span>[&lt; TMDB: adicionar o vue-router](tmdb-adicionar-vue-router "Anterior")</span> <span>[Sumário &gt;](../ "Próximo")</span></span>