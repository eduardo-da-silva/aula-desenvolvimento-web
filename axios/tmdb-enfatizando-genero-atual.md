...
<span style="display: flex; justify-content: space-between;"> <span> [&lt; TMDB: Gerenciamento de estados com o Pinia](tmdb-gerenciamento-estados-com-pinia.html 'Anterior')</span> <span>[Mostrando detalhes do filme &gt;](tmdb-mostrando-detalhes-do-filme.html 'Próximo')</span></span>
